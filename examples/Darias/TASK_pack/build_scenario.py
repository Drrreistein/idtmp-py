        ...
        with HideOutput():
            with LockRenderer():
                ...
                self.bd_body = {
                    ...
                    'c2': load_pybullet("../scenario_description/boxCm.urdf", fixed_base=False),
                    'c3': load_pybullet("../scenario_description/boxCm.urdf", fixed_base=False),
                    'c4': load_pybullet("../scenario_description/boxCm.urdf", fixed_base=False),
                    'c5': load_pybullet("../scenario_description/boxCm.urdf", fixed_base=False),
                    'c6': load_pybullet("../scenario_description/boxCm.urdf", fixed_base=False),
                    # 'c7': load_pybullet("../scenario_description/boxCm.urdf", fixed_base=False),
                    # 'c8': load_pybullet("../scenario_description/boxCm.urdf", fixed_base=False),
                    # 'c9': load_pybullet("../scenario_description/boxCm.urdf", fixed_base=False),
    ...
    def reset(self):
        with HideOutput():
            with LockRenderer():
                ...
                distance_by = 0.0505
                set_pose(self.bd_body['c1'],Pose(Point(x=0.36-distance_by,y=0.9, z=stable_z(self.bd_body['c1'], self.bd_body['region1']))))
                set_pose(self.bd_body['c2'],Pose(Point(x=0.36,      y=0.9, z=stable_z(self.bd_body['c1'], self.bd_body['region1']))))
                set_pose(self.bd_body['c3'],Pose(Point(x=0.36+distance_by,y=0.9, z=stable_z(self.bd_body['c1'], self.bd_body['region1']))))
                set_pose(self.bd_body['c4'],Pose(Point(x=0.36-distance_by,y=0.9-distance_by, z=stable_z(self.bd_body['c1'], self.bd_body['region1']))))
                set_pose(self.bd_body['c5'],Pose(Point(x=0.36,      y=0.9-distance_by, z=stable_z(self.bd_body['c1'], self.bd_body['region1']))))
                set_pose(self.bd_body['c6'],Pose(Point(x=0.36+distance_by,y=0.9-distance_by, z=stable_z(self.bd_body['c1'], self.bd_body['region1']))))
                # set_pose(self.bd_body['c7'],Pose(Point(x=0.36-distance_by,y=0.9+distance_by, z=stable_z(self.bd_body['c1'], self.bd_body['region1']))))
                # set_pose(self.bd_body['c8'],Pose(Point(x=0.36,      y=0.9+distance_by, z=stable_z(self.bd_body['c1'], self.bd_body['region1']))))
                # set_pose(self.bd_body['c9'],Pose(Point(x=0.36+distance_by,y=0.9+distance_by, z=stable_z(self.bd_body['c1'], self.bd_body['region1']))))
...
class PlanningScenario9b(object):
    def __init__(self):
        with HideOutput():
            with LockRenderer():
                self.arm_left = load_pybullet("../darias_description/urdf/darias_L_primitive_collision.urdf",
                ...
                self.bd_body = {
                    ...
                    'pegboard': load_pybullet(
                        ...
                        fixed_base=True),
                    'region1': load_pybullet("../scenario_description/region.urdf", fixed_base=True),
                    'region2': load_pybullet("../scenario_description/region.urdf",
                                             fixed_base=True),
                    ...
                    'c5': load_pybullet("../scenario_description/boxBm.urdf", fixed_base=False),
                    'c6': load_pybullet("../scenario_description/boxBm.urdf", fixed_base=False),
                    'c7': load_pybullet("../scenario_description/boxBm.urdf", fixed_base=False),
                    'c8': load_pybullet("../scenario_description/boxBm.urdf", fixed_base=False),
                    'c9': load_pybullet("../scenario_description/boxBm.urdf", fixed_base=False),
...
class PlanningScenario4b(object):
    def __init__(self):
        with HideOutput():
            with LockRenderer():
                self.arm_left = load_pybullet("../darias_description/urdf/darias_L_primitive_collision.urdf",
...
class PlanningScenario_twolayers(object):
    def __init__(self):
        with HideOutput():
            with LockRenderer():
                self.arm_left = load_pybullet("../darias_description/urdf/darias_L_primitive_collision.urdf",
                ...
                set_pose(self.bd_body['region1'],
                         Pose(Point(x=0.35, y=0.9, z=stable_z(self.bd_body['region1'], self.bd_body['floor']))))
                set_pose(self.bd_body['region2'],
                         Pose(Point(x=0.05, y=0.8, z=0.15+stable_z(self.bd_body['region2'], self.bd_body['floor']))))
    ...
    def reset(self):
        with HideOutput():
            with LockRenderer():
                ...
                set_pose(self.bd_body['c2'],Pose(Point(x=0.36,      y=0.9, z=stable_z(self.bd_body['c1'], self.bd_body['region1']))))
                set_pose(self.bd_body['c3'],Pose(Point(x=0.36-distance_by,y=0.9-distance_by, z=stable_z(self.bd_body['c1'], self.bd_body['region1']))))
                set_pose(self.bd_body['c4'],Pose(Point(x=0.36,      y=0.9-distance_by, z=stable_z(self.bd_body['c1'], self.bd_body['region1']))))
                set_pose(self.bd_body['c5'],Pose(Point(x=0.36-distance_by,y=0.9, z=stable_z(self.bd_body['c5'], self.bd_body['c1']))))
                set_pose(self.bd_body['c6'],Pose(Point(x=0.36,      y=0.9, z=stable_z(self.bd_body['c5'], self.bd_body['c1']))))
                set_pose(self.bd_body['c7'],Pose(Point(x=0.36-distance_by,y=0.9-distance_by, z=stable_z(self.bd_body['c5'], self.bd_body['c1']))))
                set_pose(self.bd_body['c8'],Pose(Point(x=0.36,      y=0.9-distance_by, z=stable_z(self.bd_body['c5'], self.bd_body['c1']))))
                # set_pose(self.bd_body['c9'],Pose(Point(x=0.36+distance_by,y=0.9+distance_by, z=stable_z(self.bd_body['c1'], self.bd_body['region1']))))
                # set_pose(self.bd_body['c2'],
                #          Pose(Point(x=0.32, y=0.9, z=stable_z(self.bd_body['c2'], self.bd_body['region1']))))
                # set_pose(self.bd_body['c3'],
