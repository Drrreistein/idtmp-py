...
python3 run_idtmp_regrasp.py -r 0.1 -n 20 -c 3 -f ../training_cnn_simple/mlp_tf_dirall_21801_40.model/ >> log_fc/idtmp_010_mlp.log
cd log_fc
./log_2_txt.sh idtmp_010_mlp
cd ..

python3 run_idtmp_regrasp.py -r 0.08 -n 20 -c 3 -f ../training_cnn_simple/mlp_tf_dirall_21801_40.model/ >> log_fc/idtmp_008_mlp.log
cd log_fc
./log_2_txt.sh idtmp_008_mlp
cd ..

python3 run_idtmp_regrasp.py -r 0.06 -n 20 -c 3 -f ../training_cnn_simple/mlp_tf_dirall_21801_40.model/ >> log_fc/idtmp_006_mlp.log
cd log_fc
./log_2_txt.sh idtmp_006_mlp
cd ..

python3 run_idtmp_regrasp.py -r 0.04 -n 20 -c 3 -f ../training_cnn_simple/mlp_tf_dirall_21801_40.model/ >> log_fc/idtmp_004_mlp.log
cd log_fc
./log_2_txt.sh idtmp_004_mlp
cd ..

python3 run_idtmp_regrasp.py -r 0.02 -n 20 -c 3 -f ../training_cnn_simple/mlp_tf_dirall_21801_40.model/ >> log_fc/idtmp_002_mlp.log
cd log_fc
./log_2_txt.sh idtmp_002_mlp
cd ..
